    ...
    var req = https.request(options, (res) => {
        ...
        res.on('end', () => {
            ...
            if (!resData.error) {
                ...
                rl.question('Please enter a nickname for this account: ', (nickname) => {
                    if (!nickname) {
                        return console.log('No nickname supplied. Try again.');
                    }
                    ...
                    conf_utils.set('active_user', user.nickname);
                    conf_utils.save();
...
function authenticate () { 
    ...
    rl.question('Do that now, then hit enter when you\'re ready.', () => makeAuthRequest());
}
